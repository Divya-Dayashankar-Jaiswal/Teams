...
<%
  ...
  {  if(request.getParameter("username").equals(e.getUsername())) 
   ...
   <%
    ...
    %>
<tr>
<th colspan="2"><input type="button" class="btn btn-outline-success" value="Add Student" onclick="location.href='AddStudent.jsp'"></th>
<th colspan="2"><input type="hidden"></th>
<th colspan="2"><input type="button" class="btn btn-outline-danger" value="Back to Panel" onclick="location.href='AdminPanel.jsp'"></th>
</tr>
</table>
